...
const Player = ({ trailer, playTrailer, noTrailer, onClose }) => {
  ...
  return (
    <div className="z-50 flex justify-center fixed inset-0">
      ...
      />
      <button
        className="absolute z-50 bottom-12 left-4 border bg-transparent text-gray-300 border-gray-300 py-2 px-5 hover:bg-red-600 hover:border-red-600 hover:text-gray-300"
